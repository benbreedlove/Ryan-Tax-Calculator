        ...
        var calculate_change = function() {
            ...
            for (politician in running_total) {
                for (var i = 0; i < tax_brackets.length; i++ ) {
                    ...
                    running_total[politician] = parseFloat(tax_brackets[(i)][politician][filing_type]) 
                                                    * income / 100
                    break;
                }
            }
...
//            jQuery('#annual_income_input').val(commafy(income));
        }
        var commafy = function(real_num) {
            num = Math.abs(real_num).toFixed(2).toString();
            num.replace('-', '');
